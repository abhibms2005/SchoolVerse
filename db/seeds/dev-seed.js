'use strict';
// dev seed data — do not run in production (guard below is the real safety net).
// Populates realistic sample rows so the app has something to show locally.
...
/* ---------- admin (minimal auth) ---------- */
const ADMIN_EMAIL = process.env.SEED_ADMIN_EMAIL || 'admin@schoolverse.local';
